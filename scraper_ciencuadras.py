...
def extract_ph(description):
    ...
    # (Conjunto/Edificio/Condominio/Urbanizacion) que ya se buscaba aqui,
    # ahora tambien reconoce menciones sueltas (PH, Propiedad Horizontal,
    # administracion incluida) que antes esta funcion no capturaba.
